...
### 17. Создание и тестирование Core Data. Для этого сделаем папку CoreData в паке Resources и создадим в ней файл модели Coredata. Название файл сделаем таким же как и название приложения
    ...
    18. Добавим в модель Entity c с названием UIToDo и добавим к этому entity необходимые для UI атрибуты:
    - id - Int64
    - todo - String - название задания
    - notes - String - заметки к заданию или описнаие задания
    - time - Date - дата задания
    - completed - Bool - статус выполнения задания
    - userId - Int64 - номер пользователя
    
    19. Установим constraint для предотвращения появления дубликатов в базе данных. Выберем id задания. Клик на название Entity в провой панели инстпекторов в model inspector в поле constraints запишем id.
